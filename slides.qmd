...
On our computer, the **file system** organizes files and directories in an (upside down) tree-like structure. In each folder, there is a parental directory, and there can be files and directories within it. 

![](https://andysbrainbook.readthedocs.io/en/latest/_images/UnixTree1.png){width="600"}
...
![](https://andysbrainbook.readthedocs.io/en/latest/_images/UnixTree1.png){width="400"}
